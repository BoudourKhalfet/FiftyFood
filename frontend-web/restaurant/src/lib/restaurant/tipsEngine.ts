...
export function generateTips(input: {
  ...
  if (revPrev > 0 && rev7 > revPrev * 1.07) {
    tips.push({
      ...
      message:
        "Your weekly revenue is climbing. Keep high-performing offers visible through peak pickup hours.",
  ...
  if (forecasts.length > 0) {
    ...
    tips.push({
      ...
      message:
        "Expected revenue remains stable with mild upward trend toward the weekend.",
