        ...
        slivers: [
          SliverAppBar(
            ...
            title: Row(
              ...
              children: [
                Row(
                  children: [Image.asset('assets/images/logo.png', height: 56)],
                ),
                Row(
                  children: [
                            ...
                            children: [
                              Expanded(
                                child: _buildStepCard(
                                  ...
                                  'Discover delicious surplus food from restaurants near you at reduced prices.',
                                ),
                              ),
                              ...
                              Expanded(
                                child: _buildStepCard(
                                  ...
                                  Icons.access_time,
                                  'Reserve Your Meal',
                                  'Choose your pickup time slot and secure your order with quick, easy payment.',
                                ),
                              ),
                              const SizedBox(width: 20),
                              Expanded(
                                child: _buildStepCard(
                                  ...
                                  Icons.place,
                                  'Pick Up & Enjoy',
                                  'Show your QR code at the restaurant and enjoy your sustainable meal!',
                                ),
                              ),
                            ],
                          )
        ...
        Text.rich(
          TextSpan(
            children: [
              const TextSpan(
                text:
                    'Join our community to rescue delicious surplus meals from local restaurants at up to ',
                style: TextStyle(
              ...
              const TextSpan(
                text: '. Good for you, great for the Earth.',
                style: TextStyle(
                  color: Color(0xFF5F6F6B),
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Padding(
                      ...
                      child: Text(
                        AppLocalizations.of(context)!.btnJoinAsClient,
                        style: const TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 14,
                        ),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    label: Padding(
                      padding: const EdgeInsets.symmetric(vertical: 14),
                      child: Text(
                        AppLocalizations.of(context)!.btnJoinAsPartner,
                        style: const TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 14,
                        ),
              ...
              child: OutlinedButton.icon(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const DelivererSignupStep1(),
                    ),
                  );
                },
                ...
                label: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  child: Text(
                    AppLocalizations.of(context)!.btnJoinAsDeliverer,
                    style: const TextStyle(
                      fontWeight: FontWeight.w700,
                      fontSize: 14,
                    ),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                Text(
                  AppLocalizations.of(context)!.labelVerifiedRestaurants,
                  style: const TextStyle(
                    color: Color(0xFF5F6F6B),
                    fontSize: 12,
                  ),
            ...
            const Row(
              ...
              children: [
                ...
                Text(
                  'AI-Powered Matching',
                  style: TextStyle(color: Color(0xFF5F6F6B), fontSize: 12),
                ),
              ],
            ),
          ],
